...
CREATE TABLE grados_has_empleados (
  grados_grado INTEGER UNSIGNED  NOT NULL  ,
  empleados_rut INTEGER UNSIGNED  NOT NULL    ,
PRIMARY KEY(grados_grado, empleados_rut)  ,
INDEX grados_has_empleados_FKIndex1(grados_grado)  ,
INDEX grados_has_empleados_FKIndex2(empleados_rut),
  FOREIGN KEY(grados_grado)
